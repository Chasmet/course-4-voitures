...
const cars = [
  { id: "player", color: "red",       lane: 0, x: 0, y: 0, w: 26, h: 50, speed: 0, distance: 0, boost: 0 },
  { id: "yellow", color: "gold",      lane: 1, x: 0, y: 0, w: 26, h: 50, speed: 0, distance: 0, boost: 0 },
  { id: "green", color: "limegreen",  lane: 2, x: 0, y: 0, w: 26, h: 50, speed: 0, distance: 0, boost: 0 },
  { id: "purple", color: "violet",    lane: 3, x: 0, y: 0, w: 26, h: 50, speed: 0, distance: 0, boost: 0 }
];
...
function updateAI() {
  ...
  for (let i = 1; i < cars.length; i++) {
    const car = cars[i];
    let target = started ? (lvl.aiBase[i - 1] + Math.sin(worldTime * 0.04 + i) * 0.20) : 0;
